...
Event e1 = new Event("Standerhejsning", "Flaget bliver hejst og der åbnes for sejlads.", new DateTime(2025,12,05,10,00,00), new DateTime(2025, 12, 05, 10, 00, 00));
Event e2 = new Event("Julefrokost", "Vi afholder den årlige julefrokost. Alle medbringer en ret.", new DateTime(2025, 12, 10, 13, 00, 00), new DateTime(2025, 12, 10, 18, 00, 00));
...
EventRepositoryList eventList1 = new EventRepositoryList();
